...
export default function Card() {
  return (
    <div className="bg-cardbg flex flex-col border-0 rounded-xl shadow-xl py-6 px-6 mx-2 my-2 group">
      <div className=" relative h-80 w-80 opacity-cyan bg-cyan rounded-2xl">
        <Image
